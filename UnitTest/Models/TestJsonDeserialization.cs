...
namespace UnitTest.Models
{
    ...
    public class TestJsonDeserialization
    {
        ...
        public void TestClient()
        {
            ...
            Assert.AreEqual(new DateTime(2013, 10, 11, 12, 1, 21, DateTimeKind.Utc), client.CreatedAt);
            Assert.AreEqual(new DateTime(2013, 10, 11, 12, 1, 21, DateTimeKind.Utc), client.UpdatedAt);
            Assert.AreEqual(0, client.Payment.Count);
            Assert.IsNull(client.Subscription);
        }
        ...
        public void TestOffer()
        {
            ...
            Assert.AreEqual(10, offer.SubscriptionCount.Active);
